...
export default function Model({ ...props }) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group position={[0, 3.71, 0]} scale={2.64}>
      ...
      <group position={[-2.03, 2.32, -0.99]} rotation={[0, 1.57, 0]} scale={[1.65, 0.11, 0.57]}>
      ...
      <group position={[-2.05, 3.01, 0.12]} rotation={[3, 0.97, -3.02]} scale={[0.77, 0.38, 0.02]}>
      ...
      <group position={[-2.05, 3.01, -1.2]} rotation={[0.15, 0.97, -0.12]} scale={[0.77, 0.38, 0.02]}>
      ...
      <group position={[-2.52, 2.73, 1.79]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} scale={[0.34, 0.34, 0.42]}>
      ...
      <group position={[-0.84, 2.44, -2.11]} rotation={[0, 0.22, 0]} scale={[0.42, 0.01, 0.28]}>
      ...
      <group position={[-1.83, 2.44, -0.75]} rotation={[0, 1.18, 0]} scale={[0.47, 0.02, 0.24]}>
      ...
      <group position={[0.07, 2.78, -0.69]} rotation={[-0.21, -0.56, -0.11]} scale={[0.42, 0.96, 0.1]}>
